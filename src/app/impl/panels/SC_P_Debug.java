...
public class SC_P_Debug extends LowBobPanel {
    ...
    public SC_P_Debug() {
        ...
        LowBobTextUI scscoreui = new LowBobTextUI(1300,760,100,40, "Visitor TT1 BRK", Color.BLUE);
        ...
        LowBobTextUI text = new LowBobTextUI(10,10,600,40, "Visitor TT1 BRK", Color.ORANGE);
        text.setText("Space  Craft 701  alpha  build  0.31");
        this.addUI(text);
    }
}
