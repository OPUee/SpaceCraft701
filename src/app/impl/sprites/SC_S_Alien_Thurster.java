...
public class SC_S_Alien_Thurster extends LowBobSprite {
	...
	public SC_S_Alien_Thurster(double x, double y, double width, double height, int z) {
	...
	public void loadImage() {
		ai_thurster = new ImageAnimator(ImageCreator.create("resources/pics/alien_flame.png"), 20);
